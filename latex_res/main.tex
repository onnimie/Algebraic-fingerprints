...
\usepackage[section]{placeins} % use to prevent figures from going to other section
...
\KEYWORDS{monimuuttuja, multilineaarinen, monomi, polynomi, algebrallinen, sormenjälki, parametrisoitu, 
kombinatorinen, FPT}
\ENKEYWORDS{multivariate, multilinear, monomial, polynomial, algebraic, fingerprints, fingerprinting, 
parameterized, combinatorial, FPT}
