...
can be reduced to instances of it. Furthermore, solving these parameterized problems 
efficiently may imply significant improvement for the parent NP-hard problems. 
Thus, solving the general $k$-multilinear monomial detection problem 
efficiently has been of great interest. Note that only time complexity is discussed here. 
