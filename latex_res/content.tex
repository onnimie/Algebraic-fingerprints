...
Algebraization is reducing a given problem into an algebraic form, i.e., a question regarding some algebraic property of some algebraic entity. 
...
Utilizing this idea, \cite{Koutis05} managed to reduce a combinatorial problem into an algebraic form, that is multilinear monomial detection. 
...
multilinear monomial detection, and thus have faster algorithms \cite{KouWil15}, \cite{Fomin17}.\nl 
