...
%TODO: Cygan, p. 337, "freshmans identity?"
...
operations that take \bigOstar{2^k} time. TODO: talk about evaluating the polynomial ($2^k$ evaluations) 
...
In \cite{Koutis08}, \citeauthor{Koutis08} \omnote*{present or past tense?}{assigns} $X$ 
...
However, if $F$ has characteristic 2, the second equation of (\ref{eq:polynomial_identity}) 
...
\subsection{The algebraic framework for parameterized problems}
