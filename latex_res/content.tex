...
Moreover, multiplication may be written with juxtaposition for brevity: $a\cdot b = ab$. 
...
Note that $\mathbf{0} \in \mathbf{K}[X]$ corresponds to $P$ with zero-coefficients, and 
$\mathbf{1} \in \mathbf{K}[X]$ corresponds to 
