...
and has thus found great success for many combinatorial problems. 
...
after addition of monomials. See also \Cref{sect:prelims_algebra}} (TODO) 
...
the non-solutions correspond to non-multilinear and valid solutions to multilinear terms. 
...
\footnote{see \Cref{sect:prelims_circuits} for information on circuits} 
representing the polynomial, 
i.e., merely the expression $C^2$ in the example above.
...
we algebrize the $k$-3D matching problem.
...
%
\begin{figure}[h]
  \includegraphics[width=0.3\textwidth, height=3.5cm]{3D_matching.png}
  \centering
...
algebraic form that is multilinear monomial detection. 
...
a monomial $X_1 \cdots X_k$ assigned to the product 
$(v_0 + v_1) \cdots (v_0 + v_k)$ survives a uniform random assignment, i.e. 
