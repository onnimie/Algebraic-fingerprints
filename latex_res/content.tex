...
The general $k$-multilinear monomial detection is solved in
...
\footnote{the number of occurrences of each color in a multilinear monomial is below some maximum}. 
