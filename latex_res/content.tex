...
\amnote{Join paragraphs}
\amnote*{Put in parentheses}{In simple terms, the matrix permanent is 
...
done on specific settings. In \amnote*[inline,nomargin]{a}{their} series of papers \cite{Chen10, Chen11a, Chen11b, Chen13a}, 
\citeauthor{Chen13a} studied complexities for different types of multivariate
polynomials
\amnote*{drop comma}, and
...
instances of multilinear monomial detection
\amnote*{drop comma}, and 
...
fastest parallel algorithms for e.g. anomaly detection with
\amnote*{still unclear what this is}{graph scan statistics}.
