...
he focused on the coefficients, 
and used characteristic 2 and fingerprints to pair non-solution 
monomials together to cancel them. 
...
\citeauthor{Björklund14} approached this problem by considering \emph{cycle covers}, i.e., 
sets of cycles on $G$ such that TODO. In terms of algebrization, 
\citeauthor{Björklund14} essentially formed 
a multivariate polynomial $P$ of cycle cover monomials, where some monomials correspond to 
Hamiltonian cycle covers. Evaluating $P$ over a suitable ring, 
non-Hamiltonian cycle covers cancel out, and we detect 
only Hamiltonian cycle covers, i.e., valid solutions.

\citeauthor{Björklund14} achieved this by labeling, i.e. fingerprinting, cycle covers such 
that all non-Hamiltonian cycle covers receive a label identical to another non-Hamiltonian cycle cover, 
and Hamiltonian cycle covers receive unique labels. Thus with characteristic 2, 
the non-solution monomials cancel out. 
It is necessary that $G$ is undirected, since 
the uniqueness of the labels of Hamiltonian cycle covers 
is achieved by introducing direction.
...
utilized the natural interpretation of matrix permanents 
as a sum of labeled cycle covers \cite{Björklund14}. 
Moreover, the determinant of a matrix over a ring of characteristic 2 
is identical to the 
permanent \cite{Björklund14}, 
which essentially allowed \citeauthor{Björklund14} to compute a determinant 
